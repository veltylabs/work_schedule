...
func (m *Module) opGetWorkSchedule(ctx router.Context) {
	...
	if err != nil {
		// Convención de estados (a nivel de ecosistema): 404 = no encontrado, 500 = únicamente errores internos
		// reales — nunca colapsar ambos (el "misterio en tiempo de ejecución" que el arnés prohíbe).
